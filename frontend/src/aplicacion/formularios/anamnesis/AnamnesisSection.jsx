...
import { CollapsibleSection, SectionCard, TextAreaField, ChoiceGroup, CheckboxGroup } from '../compartidos/ControlesClinicos.jsx';
...
export default function AnamnesisSection({ values, onChange }) {
  ...
  return <div className="undac-section-stack clinical-interview-flow">
    <SectionCard title="Motivo de consulta y enfermedad actual" subtitle="Registro fiel del motivo, evolución y evaluación general">
